...
const MUTATIONS = [
  ...
  },
  {
    ...
    guards: 'D-052: a Beat prints every parameter it resolves against',
    file: 'ui/beatCard.ts',
  ...
  },
  {
    ...
    guards: 'D-052 / D-039: a printed card may not lie about what it leaves',
    file: 'ui/beatCard.ts',
  ...
  },
  {
    ...
    guards: 'D-052: the card and the Round-end check ask the same question',
    file: 'ui/beatCard.ts',
