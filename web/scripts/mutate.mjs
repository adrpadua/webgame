...
const MUTATIONS = [
  ...
  },
  {
    ...
    guards: 'D-061: a Whelp detonates on the Incoming Row of the NEXT Round',
  ...
  },
  {
    ...
    guards: 'D-061: an Enemy blast burns Heroes only, as a Burst burns Enemies only',
    file: 'engine/minions.ts',
  ...
  },
  {
    ...
    guards: 'D-061: the blast reaches its authored radius, so a step answers it',
    file: 'engine/minions.ts',
  ...
  },
  {
    ...
    guards: 'D-061: reaching the fuse is the Brood Call going unanswered',
  ...
  },
  {
    ...
    guards: 'D-061: a Minion is consumed by its own blast',
