...
const MUTATIONS = [
  ...
  },
  {
    ...
    guards: 'D-068 authoring: a row that merged weeks ago must never be renumbered',
  ...
  },
  {
    ...
    guards: 'D-068 authoring: assigning an id must not create the duplicate it exists to prevent',
    file: 'content/decisionIds.ts',
  ...
  },
  {
    ...
    guards: 'D-068 authoring: only the ID column is the row\'s own number',
    file: 'content/decisionIds.ts',
  ...
  },
  {
    ...
    guards: 'D-067: reach is a property of every ability, the Boss included',
  ...
  },
  {
    ...
    guards: 'D-067: marking the Boss costs the same footwork as marking a Whelp',
    file: 'engine/legality.ts',
  ...
  },
  {
    ...
    guards: 'D-067: a card that touches anything past its own Hero authors a reach',
    file: 'engine/content/catalog.ts',
  ...
  },
  {
    ...
    guards: 'D-067: a reach nothing reads is a number an author can set and watch do nothing',
    file: 'engine/content/catalog.ts',
  ...
  },
  {
    ...
    guards: 'D-067: a plate that stays lit from out of reach asserts a shot the resolver refuses',
    file: 'ui/slots.ts',
  ...
  },
  {
    ...
    guards: 'D-068: marking the Party is a reach, the Boss side of D-067',
    file: 'engine/timeline.ts',
  ...
  },
  {
    ...
    guards: 'D-068: "Move 2, then Claw" swings from where the move ended, not from where it started',
    file: 'engine/timeline.ts',
  ...
  },
  {
    ...
    guards: 'D-068: a mover goes no further than it has to, so an advance is readable',
  ...
  },
  {
    ...
    guards: 'D-068: a Boss standing next to its quarry has no reason to move',
    file: 'engine/board.ts',
  ...
  },
  {
    ...
    guards: 'D-068: what stops a pathing Enemy is authored, not assumed',
    file: 'engine/board.ts',
  ...
  },
  {
    ...
    guards: 'D-068: a Hazard decides whether it burns the side that laid it, so a Boss can be lured onto its own',
    file: 'engine/resolve.ts',
  ...
  },
  {
    ...
    guards: 'D-068: range_tiles is what tells a movement clause when to stop',
    file: 'engine/content/catalog.ts',
