...
- Press and hold any card, slot, boss beat, stat, or the round track for a `Detail Popup` carrying its numbers and full rules text — or hover it with a mouse. The HUD itself stays down to names, numbers, and colour
