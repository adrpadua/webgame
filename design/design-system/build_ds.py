...
def plate_cards():
    ...
    body = (
        ...
        '<div class="ds-note">Its three gutters are variables, not constants. The measurement generalises to any '
        'raked column; the numbers were tuned on a ~374pt dock card. A 138pt party frame taking them unchanged '
        'spends a quarter of its width on padding and truncates an ally\'s name at six characters — so '
        '<b>p-raked-narrow</b> keeps the measurement and cuts the gutters to what the width affords '
        '(<span class="ds-mono">10/9</span> rather than <span class="ds-mono">18/15</span> at that size). '
        'The principle applies at every width; the constants do not.</div>'
