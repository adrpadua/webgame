...
func _initialize() -> void:
	...
	var mobile_tempo_bar: Control = main.get_node("%MobileTempoBar")
	...
	assert(mobile_tempo_bar.visible, "Mobile tempo bar must be visible above the action bar.")
	assert(mobile_prompt.visible and mobile_prompt.text.contains("Drag a card"), "The mobile prompt should explain how to proceed when setup actions remain.")
	...
	assert(mobile_tempo_bar.global_position.y < action_bar.global_position.y, "Tempo must sit above the action bar.")
