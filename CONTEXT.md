...
**Board Feedback**:
The transient motion the board plays for a resolved batch of actions: a lunge toward what was struck, a flash and floating number on what was hit, a pulse on a Hero who guarded, a glide for a step taken, a flare over a resolved telegraph, a hex catching fire under a Hazard and charring to ash. Every beat of it is derived from Resolution Facts, so the board can never show a blow the Encounter did not resolve.
