...
1. **Sequencing: build the party seams.** The Healer justifies promoting the multi-Hero model rather than waiting. **Done** — the engine and content seams shipped as D-067 / ADR 0035.
