...
| Payoff | ⏳ Fire *Riposte*: spend all Signature Charges for `3` Boss damage `+2` per Charge — cash one for tempo or bank to the cap ahead of a telegraphed hit. Elsewhere: absorb the hit that would break the line, or clear a nearby Minion. |
